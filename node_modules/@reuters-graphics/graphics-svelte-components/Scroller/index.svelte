...
div.background div.scroller-graphic-well section.graphic.background-container {
  margin-top: 0;
  margin-bottom: 0;
  min-height: 100vh;
  display: flex;
...
div.background div.scroller-graphic-well section.graphic.background-container.fluid {
  margin: 0 0 0 -15px;
}
